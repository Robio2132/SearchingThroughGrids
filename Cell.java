...
Class: CS231
Purpose: Provides funtionatlity for the cell object.  (does not need to be run.)
*/
...
public class Cell {
    ...
    public boolean equals(Object o) {
        //Returns if object o is equal to an instace of a cell object.
    ...
    public int getCost() {
        //Accesser method for cost(part of the extension.)

        return this.cost;
    }

    public void setCost(int cost) {
        //Mutator method for cost(part of the extension.)
